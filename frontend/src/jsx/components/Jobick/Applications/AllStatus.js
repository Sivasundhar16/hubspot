        ...
        >
          ...
          <tbody>
                    ...
                    <g transform="translate(0.243)">
                      ...
                      <g transform="translate(-0.243)">
                        ...
                        <ellipse
                          ...
                          rx="13.243"
                          ry="13.43"
                          transform="translate(11.152 14.922)"
                          fill="#fff"
                        />
                        <ellipse
            ...
            <tr role="row" className="even">
              ...
              <td>
                <span className="btn bgl-btn btn-outline-secondary btn-sm btn-rounded">
                  Candidate
                </span>
              </td>
              <td>
            ...
            <tr role="row" className="even">
              ...
              <td>
                <span className="btn btn-outline-danger  border-danger btn-rounded btn-sm">
                  ON HOLD
                </span>
              </td>
              <td>
            ...
            <tr role="row" className="even">
              ...
              <td>
                <span className="btn btn-outline-secondary btn-sm btn-rounded">
                  Candidate
                </span>
              </td>
              <td>
